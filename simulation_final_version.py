...
def ai1(success_num):
    ...
    if success_num is 5, it represents five stones in a row means success. And this parameter would be transformed to other functions,
too.
    :return: by using random number generator, we got one of the three best next move, here we will return the x-coordinate and y-
coordinate
